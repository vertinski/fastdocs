...
def main():
    ...
    if not os.path.exists('docs'):
        os.makedirs('docs')
    with open('docs/doc_buffer', 'w') as f:
        f.write("")

    print ("\n\n\n")
    print ("       _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _")
    print ("  -=≡|| FastDocs by Vertinski (oc) 2024 ||≡=-")
    print ("       ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯")
    print ("   Type 'exit' to quit, 'help' for explanation.\n\n")

    print ("¡Add '/docs/doc_buffer' file to AI context to start!\n")
    ...
    while True:
        ...
        user_input = input(f"[{programming_language}] Search FastDocs: ")
        ...
        if user_input.lower() == 'exit':
            ...
            print("\nNote: Replit allows very small AI context size - so the 'doc_buffer' file \nis limited to 21k characters or 5,200 tokens. Otherwise Replit will remove \nother project files from AI context, which of course sucks. Thus the buffer \ncontains only the most recent search result. Keep that in mind when \ntalking to AI.")
            print()
